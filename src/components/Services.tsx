      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-stone-500 max-w-2xl mx-auto">
            Ofrecemos soluciones completas en construcción y remodelación con
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <div
              key={service.title}
              className="group rounded-2xl border border-stone-200 p-6 hover:border-amber-300 hover:shadow-lg hover:shadow-amber-100/50 transition-all duration-300"
            >
              <div className="mb-4 inline-flex items-center justify-center rounded-xl bg-amber-50 p-3 text-amber-600 group-hover:bg-amber-100 transition-colors">
                {service.icon}
              </div>
